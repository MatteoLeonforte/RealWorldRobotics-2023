...
def tendonlength_right_joint0(theta_joint0):
   ...
   new_xy = 27**2+27**2-2*27*27*np.sin(etha)
   dxy = ground_length - new_xy  #in mm
   delta = dxy/1000              #translate into m
...
def tendonlength_flexor_joint2(theta_joint0, theta_joint2):
   ...
   return tendonlength_extensor_joint2(theta_joint0, -theta_joint2)
...
def tendonlength_flexor_joint4(theta_joint4):
   ...
   return tendonlength_extensor_joint4(-theta_joint4)
...
def tendonlength_flexor_joint6(theta_joint6):
   ...
   return tendonlength_extensor_joint6(-theta_joint6)
...
def tendonlength_flexor_joint8(theta_joint8):
   ...
   return tendonlength_extensor_joint8(-theta_joint8)
...
def tendonlength_flexor_joint10(theta_joint10):
   ...
   return tendonlength_extensor_joint10(-theta_joint10)
